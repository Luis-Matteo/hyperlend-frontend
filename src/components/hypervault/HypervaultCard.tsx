    ...
    <div className='w-full p-5 bg-gray-dark rounded-xl border-[1px] border-secondary hover:shadow-inner-3xl'>
      <div className='flex flex-col gap-2'>
        <div className='flex justify-between items-center gap-2'>
          <div
            className={`border-[1px] ${tagStyle.borderColor} flex items-center gap-2 py-2 px-3 rounded-full`}
          >
            <img className='w-4 h-4' src={tagStyle.icon} alt={tag} />
            <p className={`${tagStyle.textColor} text-xs font-nexa capitalize`}>
              {tag}
            </p>
          </div>
        ...
        <div className='flex justify-center items-center gap-16'>
          ...
          <div className='text-center'>
            <p className='text-white font-lufga font-bold text-xl'>
              ${formatNumber(tvl, 2)}
            </p>
