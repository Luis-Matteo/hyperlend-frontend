...
function CoreTable({ stable, searchText, setModalStatus, setModalType, setSelectedToken }: CoreTableProps) {
    ...
    const protocolAssetReserveDataMap = Object.keys(reserveDataMap).reduce((acc, token) => {
