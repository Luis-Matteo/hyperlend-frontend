...
function Referrals() {
  ...
  const days = [30, 14, 7];
  const data = [100000, 100358, 101006, 102529, 102295, 102060, 103640, 104407, 103938, 104480, 104017, 103551, 103793, 101880, 100155, 99592, 98580, 98894, 97986, 96574, 98039, 97813, 97881, 96456, 95912, 96023, 94872, 95247, 94647, 94355, 93753, 95606, 95592, 94534, 95357, 94136, 94345, 92385, 91057, 91254, 91992, 92164, 92048, 91747, 90269, 89549, 89088, 90145, 90489, 88726, 89050, 88665, 87988, 88600, 89631, 90562, 89723, 89413, 89745, 90720, 90241, 90055, 88949, 87753, 88565, 89922, 89850, 90853, 91215, 90570, 90931, 92469, 92433, 93998, 91378, 92200, 92287, 91988, 92080, 90092, 89873, 90230, 91708, 91189, 90381, 89879, 90795, 91123, 90593, 91107, 91204, 92172, 91470, 91143, 90751, 89287, 89583, 89844, 89849, 89615, 88199, 87779, 87436, 86634, 86473, 86877, 88763, 88937, 89195, 89120, 87202, 87175, 87235, 89699, 89506, 89808, 89773, 88604, 89747, 90499, 91290, 90381, 91784, 90382, 90969, 93159, 92169, 91602, 91702, 91198, 89648, 89716, 88654, 89128, 88208, 89758, 88975, 88653, 89466, 88235, 88463, 89770, 88163, 88347, 88607, 89389, 88152, 86832, 87353, 87650, 87901, 88247, 87567, 87800, 88093, 87378, 89244, 89718, 88527, 89183, 88209, 88996, 90154, 89334, 90297, 90710, 91532, 93429]
                ...
                <>
                  {
                    !history ?
                      ...
                      :
                      <div
                        className="bg-[#1F2A29] rounded-md px-6 py-5 w-full ">
                        <button className="flex gap-1 items-center"
                          onClick={() => setHistory(false)}>
                          <div className="">
                            <img src={leftArrow} alt="left" />
                          </div>
                          <p className="text-secondary font-lufga text-opacity-40 text-xs font-black px-2">Back to Earnings</p>
                        </button>
                        <div className="mt-5 mb-1 py-3 bg-[#CAEAE5] bg-opacity-40 rounded-md flex justify-between items-center">
                          <p className="max-w-[140px] w-full text-center text-white text-xs font-medium font-lufga">Wallets</p>
                          <p className="w-full text-center text-white text-xs font-medium font-lufga">Commission Generated</p>
                        </div>
                        <div className="max-h-[360px] h-full overflow-auto">
                          {
                            (earningHistory || []).map((item, key) => (
                              <div className="flex py-3 border-b-[1px] border-[#212325]" key={key}>
                                <p className="max-w-[140px] w-full text-center text-white font-lufga">{formatAddress(item.wallet)}</p>
                                <p className="w-full text-center text-success font-lufga">${item.commission}</p>
                              </div>
                            ))
                          }
                        </div>
