  ...
  return (
    <>
      <div className="w-full">
        ...
        />
        <CardItem
          className="md:py-6 md:px-7 flex-1"
        >
          <div>
            <div className="">
                ...
                <div className="text-white font-lufga text-[11px] col-span-2">Asset</div>
                {
                  (assetsInfos || []).map((item, key) => (
                    <div className="flex gap-2 items-center" key={key}>
                      <p className='text-white font-lufga text-[11px]'>{item.title}</p>
                      <InfoItem
              ...
              <div className="max-h-[800px] h-full overflow-auto hidden lg:block">
                {
